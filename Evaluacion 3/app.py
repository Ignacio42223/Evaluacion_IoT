...
# =======================================================
SUPABASE_URL = "https://bgmpoyppjvbuudlyjkgx.supabase.co"

# Pega aquí tu llave pública de Supabase
SUPABASE_KEY = "sb_publishable_XMmvjIF_-4Sut_63ihwCIw_nCfu7plC"

MQTT_BROKER = "broker.hivemq.com"
MQTT_PORT = 1883
MQTT_TOPIC_PUB = "aula/control"  # Canal donde Flask PUBLICA las órdenes para los LEDs
MQTT_TOPIC_SUB = "aula/monitor"  # Canal donde Flask ESCUCHA las temperaturas del ESP32
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if "Ignacio Henseleit" in payload_txt:
            ...
            datos_insertar = {
                "dispositivo": "Ignacio Henseleit",
                "temperatura": temp_val,
                "contador": cont_val
            }
            # Guardado automático con año/mes/día/hora/segundo mediante default now() 
            supabase.table("monitoreo_proceso").insert(datos_insertar).execute()
