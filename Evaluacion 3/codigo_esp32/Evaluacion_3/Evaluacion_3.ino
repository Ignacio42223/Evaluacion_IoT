...
// =======================================================
const char* ssid = "Aynara";       
const char* password = "Taira1974";   
...
const char* mqtt_topic_pub = "aula/monitor";  // Canal donde el ESP32 publica
const char* mqtt_topic_sub = "aula/control";  // Canal donde el ESP32 escucha comandos
...
void loop() {
  ...
  if (now - lastMsg > 5000) {
    ...
    String mensaje = "Ignacio Henseleit | Temperatura: " + String(random(20, 35)) + "C | Contador: " + String(contador);
